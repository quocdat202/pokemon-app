...
function App() {
  ...
  const displayPokemon: any = showFavorites ? favorites : pokemon;
  console.log("🤔🤔🤔 ~ App ~ displayPokemon:", displayPokemon);
    ...
    >
      ...
      {isAuthenticated && (
        <main>
          ...
          >
            {displayPokemon &&
              displayPokemon?.data?.map((poke: any) => (
                <PokemonCard
                  key={poke.id}
                  pokemon={poke}
